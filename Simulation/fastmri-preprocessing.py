...
def preprocess_all_fastmri(input_dir, output_dir, batch_size=5000):
    """Preprocess all FastMRI data files in batches"""
    file_list = [f for f in os.listdir(input_dir) if f.endswith('.h5')]
...
# Usage
input_dir = "../../Data/multicoil_train"
output_dir = "./Output"
preprocess_all_fastmri(input_dir, output_dir, batch_size=5000)
